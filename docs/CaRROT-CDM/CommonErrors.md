...
<center>
[FAQ: How can I install the tool offline?](/CaRROT-Docs/CaRROT-CDM/FAQ/#how-can-i-install-the-software-offline-no-internet-connection){ .md-button .md-button--primary}
</center>
