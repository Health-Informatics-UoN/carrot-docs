...
If you cannot obtain the original WhiteRabbit scan report, you can also generate synthetic data using our CCOM website by connecting via the [api](/CaRROT-Docs/CaRROT-Mapper/API/) to the database.
