...
For co-connect datapartners, you will be supplied this `json` file by the co-connect team, who create this file based on a WhiteRabbit ScanReport uploaded and then mapped on the [CaRROT-Mapper](../../CaRROT-Mapper/about.md) mapping website.
